...
Edited 10/2014 by Theodore Nowak
...
void Adafruit_L3GD20_Unified::getEvent(sensors_event_t* event)
{
  ...
  while(!readingValid)
  {
    ...
    _gyroData.x = (int16_t)(xlo | (xhi << 8));
    _gyroData.y = (int16_t)(ylo | (yhi << 8));
    _gyroData.z = (int16_t)(zlo | (zhi << 8));
  ...
  switch(_range)
  {
    case GYRO_RANGE_250DPS:
     ...
     /* _gyroData.x *= GYRO_SENSITIVITY_250DPS;
      _gyroData.y *= GYRO_SENSITIVITY_250DPS;
      _gyroData.z *= GYRO_SENSITIVITY_250DPS;8*/
      break;
    case GYRO_RANGE_500DPS:
      event->gyro.x *= GYRO_SENSITIVITY_500DPS;
      event->gyro.y *= GYRO_SENSITIVITY_500DPS;
      event->gyro.z *= GYRO_SENSITIVITY_500DPS;
      /*_gyroData.x *= GYRO_SENSITIVITY_500DPS;
      _gyroData.y *= GYRO_SENSITIVITY_500DPS;
      _gyroData.z *= GYRO_SENSITIVITY_500DPS;*/
      break;
    case GYRO_RANGE_2000DPS:
      event->gyro.x *= GYRO_SENSITIVITY_2000DPS;
      event->gyro.y *= GYRO_SENSITIVITY_2000DPS;
      event->gyro.z *= GYRO_SENSITIVITY_2000DPS;
     /* _gyroData.x *= GYRO_SENSITIVITY_2000DPS;
      _gyroData.y *= GYRO_SENSITIVITY_2000DPS;
      _gyroData.z *= GYRO_SENSITIVITY_2000DPS;*/
  ...
  //_gyroData.x *= SENSORS_DPS_TO_RADS;
  //_gyroData.y *= SENSORS_DPS_TO_RADS;
  //_gyroData.z *= SENSORS_DPS_TO_RADS;
}
